...
class Cadastro():
    ...
    def tela_cadastro(self):
        ...
        # Cliente
        self.btn_cadastro_cliente = ctk.CTkButton(master = self.frame_menu_cadastro, text= 'Cadastrar cliente', width = 300, font=('Roboto', 14), corner_radius= 20)                           
    ...
    def cadastra_veiculo(self):
        ...
        # cadastrar
        self.btn_cadastrar = ctk.CTkButton(master =self.frame_cadastro_veiculo, text= 'Cadastrar', width = 85, font=('Roboto', 12), corner_radius= 20, fg_color = 'gray')                       
